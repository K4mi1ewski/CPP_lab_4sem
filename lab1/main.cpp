...
Pliki .h znajduja się w katalogu include, a .cpp w src, main.cpp i CMakeLists.txt w głównym zadania.
...
Zawsze będziemy wysyłać indentyczny zestaw plików i katalogów, więc można zdefiniowac sobie alias.
*/
