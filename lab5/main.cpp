/*
  ...
  * opcjonalnie metodę List::reverse - odwraca listę, zmieniając ją i ją zwraca
  ...
  UWAGI:
  * Aby podane wyżej funkcje działały prawidłowo, trzeba rozszerzyć zdefiniowane wcześniej klasy.
  * Zadanie ma nie zawierać niepotrzebnych funkcji. Jeśli zostały zaimplementowane "na wszelki wypadek", a nie są potrzebne, należy je usunąć.
